      ...
      <div className="w-full max-w-sm bg-zinc-900 p-6 rounded-2xl">
        ...
        <div className="space-y-4">
          ...
          <button
            ...
            className="relative w-full bg-white text-zinc-700 border border-zinc-300 p-3 rounded-xl font-semibold flex items-center justify-center shadow-sm hover:bg-zinc-50 transition"
          >
            <GoogleLogo />
